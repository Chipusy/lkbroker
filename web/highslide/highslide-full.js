...
******************************************************************************/
var hs = {
editGrup: function (id, name) {
	var r=window.parent.document.getElementByID("podgrup_id");
	alert(r);
},
// Language strings
lang : {
	...
	creditsText : 'ЛК-Брокер',
	creditsTitle : 'Каталог изъятой техники',
	previousText : 'Предыдущая',
	nextText : 'Next', 
	moveText : 'Переместить',
	closeText : 'Закрыть', 
	closeTitle : 'Закрыть (esc)', 
	resizeTitle : 'Раздвинуть',
	playText : 'Play',
	...
	fullExpandText : '1:1',
	number: 'Фото %1 из %2',
	restoreTitle : 'Кликайте для закрытия изображения, кликайте и не отпускайте кнопку мыши для перемещения. '
},
