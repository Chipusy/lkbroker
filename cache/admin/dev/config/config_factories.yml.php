...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/www/lk-broker/log/admin_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/www/lk-broker/cache/admin/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/www/lk-broker/apps/admin/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/www/lk-broker/cache/admin/dev/template',
  'lifetime' => 86400,
  'prefix' => '/www/lk-broker/apps/admin/template',
)));
