...
class CompanyTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('PATRON', 'Patron', 'VARCHAR', false, 255, null);
		...
		$this->addColumn('ADRESS', 'Adress', 'LONGVARCHAR', false, null, null);
	...
	{
    $this->addRelation('Element', 'Element', RelationMap::ONE_TO_MANY, array('id' => 'company_id', ), 'CASCADE', null);
	} // buildRelations()
