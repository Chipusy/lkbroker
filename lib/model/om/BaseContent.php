...
abstract class BaseContent extends BaseObject  implements Persistent {
	...
	public function setTemplate($v)
	{
		...
		if ($this->template !== $v) {
			$this->template = $v;
			$this->modifiedColumns[] = ContentPeer::TEMPLATE;
		}
	...
	public function setParent($v)
	{
		...
		if ($this->parent !== $v) {
			$this->parent = $v;
			$this->modifiedColumns[] = ContentPeer::PARENT;
		}
	...
	public function setPagetitle($v)
	{
		...
		if ($this->pagetitle !== $v) {
			$this->pagetitle = $v;
			$this->modifiedColumns[] = ContentPeer::PAGETITLE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->template = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ContentPeer::TEMPLATE)) $criteria->add(ContentPeer::TEMPLATE, $this->template);
		if ($this->isColumnModified(ContentPeer::PARENT)) $criteria->add(ContentPeer::PARENT, $this->parent);
		if ($this->isColumnModified(ContentPeer::PAGETITLE)) $criteria->add(ContentPeer::PAGETITLE, $this->pagetitle);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPagetitle($this->pagetitle);
