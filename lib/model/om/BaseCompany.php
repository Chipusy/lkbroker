...
abstract class BaseCompany extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the patron field.
	 * @var        string
	 */
	protected $patron;
	...
	/**
	 * Set the value of [patron] column.
	 * 
	 * @param      string $v new value
	 * @return     Company The current object (for fluent API support)
	 */
	public function setPatron($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->patron !== $v) {
			$this->patron = $v;
			$this->modifiedColumns[] = CompanyPeer::PATRON;
		}
	...
	public function setAdress($v)
	{
		...
		if ($this->adress !== $v) {
			$this->adress = $v;
			$this->modifiedColumns[] = CompanyPeer::ADRESS;
		}
	...
	public function setProcent($v)
	{
		...
		if ($this->procent !== $v) {
			$this->procent = $v;
			$this->modifiedColumns[] = CompanyPeer::PROCENT;
		}
	...
	public function setComment($v)
	{
		...
		if ($this->comment !== $v) {
			$this->comment = $v;
			$this->modifiedColumns[] = CompanyPeer::COMMENT;
		}
	...
	public function setOurComment($v)
	{
		...
		if ($this->our_comment !== $v) {
			$this->our_comment = $v;
			$this->modifiedColumns[] = CompanyPeer::OUR_COMMENT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->patron = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->phone = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->fax = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->site = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->city = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->adress = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->procent = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			...
			return $startcol + 11; // 11 = CompanyPeer::NUM_COLUMNS - CompanyPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
			$keys[2] => $this->getPatron(),
			$keys[3] => $this->getPhone(),
			$keys[4] => $this->getFax(),
			$keys[5] => $this->getSite(),
			$keys[6] => $this->getCity(),
			$keys[7] => $this->getAdress(),
			$keys[8] => $this->getProcent(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setPatron($arr[$keys[2]]);
		...
		if (array_key_exists($keys[7], $arr)) $this->setAdress($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setProcent($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CompanyPeer::PATRON)) $criteria->add(CompanyPeer::PATRON, $this->patron);
		...
		if ($this->isColumnModified(CompanyPeer::ADRESS)) $criteria->add(CompanyPeer::ADRESS, $this->adress);
		if ($this->isColumnModified(CompanyPeer::PROCENT)) $criteria->add(CompanyPeer::PROCENT, $this->procent);
		if ($this->isColumnModified(CompanyPeer::COMMENT)) $criteria->add(CompanyPeer::COMMENT, $this->comment);
		if ($this->isColumnModified(CompanyPeer::OUR_COMMENT)) $criteria->add(CompanyPeer::OUR_COMMENT, $this->our_comment);
	 ...
	 * related Elements from storage. If this Company is new, it will return
		...
		if ($this->collElements === null) {
			if ($this->isNew()) {
			   $this->collElements = array();
				...
				$criteria->add(ElementPeer::COMPANY_ID, $this->id);
	 ...
	 */
	public function getElementsJoinCategory($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CompanyPeer::DATABASE_NAME);
		}
		...
		if ($this->collElements === null) {
			if ($this->isNew()) {
				...
				$this->collElements = ElementPeer::doSelectJoinCategory($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
