...
abstract class BaseOrderStatus extends BaseObject  implements Persistent {
	 ...
	 * Otherwise if this OrderStatus has previously been saved, it will retrieve
	 * related Orders from storage. If this OrderStatus is new, it will return
		...
		if ($this->collOrders === null) {
			if ($this->isNew()) {
			   $this->collOrders = array();
				...
				$criteria->add(OrderPeer::ORDER_STATUS_ID, $this->id);
