...
/**
 * Base static class for performing query and update operations on the 'modx_site_content' table.
 *
 * 
 *
...
abstract class BaseContentPeer {
	...
	const ID = 'modx_site_content.ID';

	/** the column name for the TEMPLATE field */
	const TEMPLATE = 'modx_site_content.TEMPLATE';

	/** the column name for the PARENT field */
	const PARENT = 'modx_site_content.PARENT';

	/** the column name for the PAGETITLE field */
	const PAGETITLE = 'modx_site_content.PAGETITLE';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'modx_site_content.DESCRIPTION';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Template', 'Parent', 'Pagetitle', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'template', 'parent', 'pagetitle', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TEMPLATE, self::PARENT, self::PAGETITLE, self::DESCRIPTION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'template', 'parent', 'pagetitle', 'description', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Template' => 1, 'Parent' => 2, 'Pagetitle' => 3, 'Description' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'template' => 1, 'parent' => 2, 'pagetitle' => 3, 'description' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TEMPLATE => 1, self::PARENT => 2, self::PAGETITLE => 3, self::DESCRIPTION => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'template' => 1, 'parent' => 2, 'pagetitle' => 3, 'description' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ContentPeer::TEMPLATE);
		$criteria->addSelectColumn(ContentPeer::PARENT);
		$criteria->addSelectColumn(ContentPeer::PAGETITLE);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to modx_site_content
	...
	/**
	 * Method to DELETE all rows from the modx_site_content table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
