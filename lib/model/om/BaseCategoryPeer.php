...
abstract class BaseCategoryPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ParentId', 'Name', 'Header', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'parentId', 'name', 'header', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PARENT_ID, self::NAME, self::HEADER, self::DESCRIPTION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'parent_id', 'name', 'header', 'description', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ParentId' => 1, 'Name' => 2, 'Header' => 3, 'Description' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'parentId' => 1, 'name' => 2, 'header' => 3, 'description' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PARENT_ID => 1, self::NAME => 2, self::HEADER => 3, self::DESCRIPTION => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'parent_id' => 1, 'name' => 2, 'header' => 3, 'description' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
