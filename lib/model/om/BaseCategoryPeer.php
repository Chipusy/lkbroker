...
abstract class BaseCategoryPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ParentId', 'Header', 'Name', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'parentId', 'header', 'name', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PARENT_ID, self::HEADER, self::NAME, self::DESCRIPTION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'parent_id', 'header', 'name', 'description', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ParentId' => 1, 'Header' => 2, 'Name' => 3, 'Description' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'parentId' => 1, 'header' => 2, 'name' => 3, 'description' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PARENT_ID => 1, self::HEADER => 2, self::NAME => 3, self::DESCRIPTION => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'parent_id' => 1, 'header' => 2, 'name' => 3, 'description' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CategoryPeer::HEADER);
	...
	{
		// invalidate objects in CategoryPreferencePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related CategoryPreference objects
			$criteria = new Criteria(CategoryPreferencePeer::DATABASE_NAME);
			
			$criteria->add(CategoryPreferencePeer::CATEGORY_ID, $obj->getId());
			$affectedRows += CategoryPreferencePeer::doDelete($criteria, $con);

			// delete related Element objects
			$criteria = new Criteria(ElementPeer::DATABASE_NAME);
			
			$criteria->add(ElementPeer::CATEGORY_ID, $obj->getId());
