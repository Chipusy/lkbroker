...
abstract class BaseOrder extends BaseObject  implements Persistent {
	...
	public function setElementId($v)
	{
		...
		if ($this->element_id !== $v) {
			$this->element_id = $v;
			$this->modifiedColumns[] = OrderPeer::ELEMENT_ID;
		}
	...
	public function setClientId($v)
	{
		...
		if ($this->client_id !== $v) {
			$this->client_id = $v;
			$this->modifiedColumns[] = OrderPeer::CLIENT_ID;
		}
	...
	public function setDate($v)
	{
		...
		if ( $this->date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = OrderPeer::DATE;
			}
	...
	public function setComment($v)
	{
		...
		if ($this->comment !== $v) {
			$this->comment = $v;
			$this->modifiedColumns[] = OrderPeer::COMMENT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = OrderPeer::NUM_COLUMNS - OrderPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OrderPeer::ELEMENT_ID)) $criteria->add(OrderPeer::ELEMENT_ID, $this->element_id);
		if ($this->isColumnModified(OrderPeer::CLIENT_ID)) $criteria->add(OrderPeer::CLIENT_ID, $this->client_id);
		if ($this->isColumnModified(OrderPeer::ORDER_STATUS_ID)) $criteria->add(OrderPeer::ORDER_STATUS_ID, $this->order_status_id);
		if ($this->isColumnModified(OrderPeer::DATE)) $criteria->add(OrderPeer::DATE, $this->date);
		if ($this->isColumnModified(OrderPeer::COMMENT)) $criteria->add(OrderPeer::COMMENT, $this->comment);
