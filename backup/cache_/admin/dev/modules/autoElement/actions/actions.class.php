...
require_once(dirname(__FILE__).'/../lib/BaseElementGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseElementGeneratorHelper.class.php');
 ...
 */
abstract class autoElementActions extends sfActions
{
