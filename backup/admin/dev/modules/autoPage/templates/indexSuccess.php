...
<div id="sf_admin_container">
  <h1><?php echo __('Простые страницы', array(), 'messages') ?></h1>

  <?php include_partial('page/flashes') ?>

  <div id="sf_admin_header">
    <?php include_partial('page/list_header', array('pager' => $pager)) ?>
  </div>
  ...
  <div id="sf_admin_content">
    <?php include_partial('page/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper)) ?>
  ...
  <div id="sf_admin_footer">
    <?php include_partial('page/list_footer', array('pager' => $pager)) ?>
  </div>
</div>
